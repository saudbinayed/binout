...
Furthermore, several d3plot files were generated by `LS-DYNA`. However, we have provided the root (or first) d3plot file as this is small (in size), and it is the one
...
<p align="center"><img alt="Energies plot" src="../figs/energies.svg" width="10%"/></p>
