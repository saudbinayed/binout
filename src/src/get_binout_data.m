...
%% What this does?
% This function reads all binary data from one or more LS-DYNA "binout" file(s) and retreive variables names and 
% ... store them as fields in the output structure. The heiraracy of the binout file is preserved.
% ======================================
%% input:
% binout_filename = [string] name of binout file (relative or absolute path)
% ======================================
%% output:
...
% exmples: binin.matsum has immediate fields: "data" and "meta"
% example: binin.elout has (possibly) the intermediate fields: "solid","shell","thickshell","beam","solid_hist","shell_hist","thickshell_hist"
% the binin.elout.solid is the one that has the sub-fields "data" and "meta", and so on.
%========================================
%% Contributions: 
...
% clear;
% clc;
% binout_filename='OUT\SHELL_2DR_NU\SHELL_2DR_NU_5\shell_2dr_nu_7\binout';
%========================================
%
...
con_fac=[1,2,4,8,1,2,4,8,4,8]; %bytes/data_entry: (#bits/8)/data_entry
...
%
% Getting control data from root d3plot file:
word_length=4;
d3plot0_filename=[erase(char(binout_filename),'binout'),'d3plot'];
